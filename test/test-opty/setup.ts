...
import { approveTokens, insertDataCurveDeposit, insertDataCurveSwap } from "../../helpers/contracts-actions";
...
export async function setUp(owner: Signer): Promise<[CONTRACTS, CONTRACTS]> {
  ...
  await insertDataCurveSwap(owner, adapters["CurveSwapAdapter"]);
