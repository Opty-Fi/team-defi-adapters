 ...
 */
contract AdvancePool is ERC20, Modifiers, ReentrancyGuard, PoolStorage, Deployer {
    ...
    constructor(
        ...
        public
        ERC20(
            string(abi.encodePacked("op ", ERC20(_underlyingToken).name(), " advance", " pool")),
            string(abi.encodePacked("op", ERC20(_underlyingToken).symbol(), "AdvPool"))
        )
        Modifiers(_registry)
    {
        setProfile("advance");
