 ...
 */
contract Vault is VersionedInitializable, IVault, ERC20, ModifiersUpgradeable, ReentrancyGuard, PoolStorage, Deployer {
    ...
    function initialize(
        ...
        _setName(string(abi.encodePacked("Well done!")));
