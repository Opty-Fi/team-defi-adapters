...
interface IVault {
     ...
     * @return _success returns true on successfully setting risk profile name.
     */
     ...
     * @return _success return true on successful persisting underlying asset address
     */
     ...
     * @return _success returns true on successful setting of the max vault value jump
     */
     ...
     * @return _success returns true on successful deposting underlying token without rebalance
     */
     ...
     * @return _success returns true on successful deposit of the underlying token
     */
