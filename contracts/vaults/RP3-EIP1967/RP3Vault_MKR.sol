 ...
 *
 * @dev Opty.Fi's RP3 Pool contract for MKR token
 */
contract RP3Vault_MKR is VersionedInitializable, IVault, ERC20, Modifiers, ReentrancyGuard, PoolStorage, Deployer {
    ...
    constructor(
        ...
        public
        ERC20(
            string(abi.encodePacked("op ", "Maker", " RP3", " pool")),
            string(abi.encodePacked("op", "MKR", "RP3Pool"))
        )
        Modifiers(_registry)
    {
    ...
    function initialize(
        ...
        _setName(string(abi.encodePacked("op ", "Maker", " RP3", " pool")));
        _setSymbol(string(abi.encodePacked("op", "MKR", "RP3Pool")));
